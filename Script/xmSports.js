...
[task_local]
# 小米运动
15 17 * * * https://github.com/zhihenglu/SurgeModule/raw/master/Script/xmSports.js, tag=小米运动, img-url=https://6678888.xyz/quantumultX/xmbs.png, enabled=true
[rewrite_local]
# 小米运动获取Token
...
const step = randomFriendPin($.getdata('xmMinStep')*1 || 50000, $.getdata('xmMaxStep')*1 || 65000);
function getToken() {
  if ($response.body) {
